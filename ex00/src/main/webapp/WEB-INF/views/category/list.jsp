...
<link rel="stylesheet" href="/resources/styles/categorylist.css">
		...
		<div class="card">
			...
			<div class="card-body">
				<!-- Nav tabs -->
										<h3>
							카테고리 대분류 &nbsp;&nbsp;
							<button class="btn btn-primary btn-sm" data-toggle="tab" data-cate_code1="${vo.cate_code1}" id="writeBigBtn"">
				...
				<ul class="nav nav-tabs">
					...
					<c:forEach items="${listBig }" var="vo">
						<li class="nav-item"><a class="nav-link bigCateData
								${(vo.cate_code1 == cate_code1)?'active':''}" data-toggle="tab" href="#mid_category" data-cate_code1="${vo.cate_code1}">
					...
					<div id="mid_category" class="container tab-pane active">
						...
						<ul class="list-group">
							<c:forEach items="${ listMid}" var="vo">
								<li class="list-group-item" data-cate_code1="${vo.cate_code1}" data-cate_code2="${vo.cate_code2 }"><span class="float-left">
