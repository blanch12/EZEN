						...
						<div class="gallery dataRow">
							<div>
								...
								<div class="gallery-text">
									<span class="goods_no" data-goods_no="${vo.goods_no}">
										상품번호 : ${vo.goods_no}</span> <br>
									<span>${vo.cate_name }</span> <br>
									<span>상품명 : ${vo.goods_name}</span> <br>
									<span class="price">정가 : <fmt:formatNumber
											value="${vo.price}" /> 원</span> <br>
									<span class="sale">할인가 : <fmt:formatNumber
											value="${vo.sale_price}" /> 원</span> <br>
									<span>적립율 : ${vo.saved_rate}</span> <br>
