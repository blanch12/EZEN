		...
		<div class="card">
			...
			<form action="update.do" method="post" enctype="multipart/form-data">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<label for="woman_cate_code1">대분류</label> <select class="form-control"
							id="woman_cate_code1" name="woman_cate_code1">
					...
					<div class="form-group">
						<label for="woman_cate_code2">중분류</label> <select class="form-control"
							id="woman_cate_code2" name="woman_cate_code2">
					...
					<div class="form-group">
						...
						<label for="imageMain">대표이미지</label> <img alt=""
							src="${womanVO.woman_image_name }" style="width: 100px; height: 100px;">
					</div>
					<div class="form-group">
