package org.zerock.qnareply.controller;
...
public class QnaReplyRestController {
	...
	public ResponseEntity<Map<String, Object>> 
		...
		// pageObject 넘겨줍니다.
		List<QnaReplyVO> list = service.list(pageObject, no);
	...
	public ResponseEntity<String> write(@RequestBody QnaReplyVO vo, HttpSession session) {
	...
	public ResponseEntity<String> update(@RequestBody QnaReplyVO vo, HttpSession session) {
		log.info("update.do ---------------------------------");
	...
	// 어노테이션이 필요없습니다.
	public ResponseEntity<String> delete(QnaReplyVO vo, HttpSession session) {
		log.info("delete.do --------------------------------------");
