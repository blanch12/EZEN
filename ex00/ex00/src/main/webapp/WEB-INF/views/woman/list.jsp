	...
	<div class="wrap">
		<section class="woman_main">
			<div class="woman_banner">
				<img alt="여성배너 " src="/resources/image/woman/woman_banner.png">
			</div>
		</section>
							...
							<div>
								...
								<div class="gallery-text">
									<span class="woman_no" data-woman_no="${vo.woman_no}">
										상품번호 : ${vo.woman_no}</span> <br> <span>
										${vo.woman_cate_name }</span> <br> <span>상품명 :
										${vo.woman_name}</span> <br> <span class="price">정가 : <fmt:formatNumber
											value="${vo.price}" /> 원
