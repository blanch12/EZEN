				...
				<div class="row">
					<div class="col-md-6">
						...
						<div id="bigImageDiv" class="img-thumbnail">
							<img src="${vo.brands_image_name }" style="width: 100%;">
						</div>
					...
					<div class="col-md-6" id="goodsDetailDiv">
						...
						<div>
							<i class="fa fa-caret-right"></i> 상품 번호 : ${vo.brands_no }
						</div>
						<div>
							<i class="fa fa-caret-right"></i> 브랜드 : ${vo.brands_cate_name }
						</div>
						<div>
							<i class="fa fa-caret-right"></i> 상품명 : ${vo.brands_name }
						</div>
						<div>${vo.content }</div>
						<div>
						...
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text">사이즈</span> <select
									class="form-control" id="brands_size_name">
									<option>=========</option>
						...
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text">색상</span> <select
									class="form-control" id="brands_color_name">
									<option>=========</option>
